...
\copyrightpage[file=scans/lxp-copyright.pdf]
...
\input{contents/main_chapter2}
\input{contents/main_chapter3}
\input{contents/main_chapter4}
\input{contents/main_chapter5}
\input{contents/main_chapter6}
