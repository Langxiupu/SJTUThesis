...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {大规模LEO星座的分布式智能资源管控与QoS保障技术研究},
    en / title           = {Research on Distributed Intelligent Resource Management and QoS Assurance Techniques for Large-Scale LEO Satellite Constellations},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    zh / keywords        = {大规模低轨卫星星座，分布式智能资源管控，移动性管理，网络切片，分布式路由，QoS保障},
    en / keywords        = {Large-Scale LEO Satellite Constellations, Distributed Intelligent Resource Management, Mobility Management, Network Slicing, Distributed Routing,   QoS Assurance},
    %
    % 姓名
    %
    zh / author          = {郎修璞},
